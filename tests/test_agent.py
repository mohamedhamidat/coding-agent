...
class TestAgentSecurity:
    ...
    @pytest.mark.asyncio
    async def test_limits_iterations(self):
    ...
    @pytest.mark.asyncio
    async def test_handles_llm_errors(self):
...
class TestAgentToolExecution:
    ...
    async def test_executes_single_tool(self):
        ...
        # Note: With async execution, execute is not called directly anymore
        # Tools are executed via async_executor
    ...
    async def test_executes_multiple_tools(self):
        ...
        result = await agent.process_message("list and read")

        # With async, tools execute via async_executor, not directly
        assert "Done" in result

    @pytest.mark.asyncio
    async def test_no_tools_returns_directly(self):
